...
profit_by_category_piechart = xp.pie(profit_by_category,names=profit_by_category.index,values="LUCRO",title="Media Percentual %",hole=.6, color=profit_by_category.index,
